...
export const CATEGORIES = {
  ...
  liturgy:                    { name: '典礼文／典礼聖歌' },
  horatius:                   { name: 'ホラティウス' },
  catullus:                   { name: 'カトゥルス' },  
  plato:                      { name: 'プラトン' },
  meleager:                   { name: 'メレアグロス' },
  palladas:                   { name: 'パラダス' },
  simonides:                  { name: 'シモニデス' },  
  kavafis:                    { name: 'カヴァフィス' },
  mavilis:                    { name: 'マヴィリス' },
