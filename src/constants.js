...
export const AUTHOR_COLOR_MAP = {
  ...
  nervo:            { dark: 'bg-violet-900/40 text-violet-300', light: 'bg-violet-100 text-violet-800' },
  hieronymus:       { dark: 'bg-amber-900/40 text-amber-300',   light: 'bg-amber-100 text-amber-800' },
  liturgy:          { dark: 'bg-rose-900/40 text-rose-300',    light: 'bg-rose-100 text-rose-800' },
  horatius:         { dark: 'bg-sky-900/40 text-sky-300',      light: 'bg-sky-100 text-sky-800' },
  catullus:         { dark: 'bg-violet-900/40 text-violet-300', light: 'bg-violet-100 text-violet-800' },
  ...
  simonides:            { dark: 'bg-violet-900/40 text-violet-300', light: 'bg-violet-100 text-violet-800' },
  ...
  karyotakis:       { dark: 'bg-blue-900/40 text-blue-300',    light: 'bg-blue-100 text-blue-800' },
