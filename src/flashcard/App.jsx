...
// ── 全テキスト統合 ────────────────────────────────────────────
const ALL_TEXTS = {
  ...baudelaireData, ...mallarmeData, ...valeryData,
  ...verlaineData,  ...gautierData,   ...valmoreData,
  ...lecontelisleData, ...rodenbachData, ...vanlerbergheData,
  ...racineData,    ...rimbaudData,   ...poeData,
  ...wildeData,     ...swinburneData, ...yeatsData,
  ...georgeData,    ...hofmannsthalData, ...traklData,
  ...hoelderlinData,
};
